...
// TextSearchLegacyMemeToken uses existing text index to search legacy collection list to get relevant collections.
func (sdb *SharedMongoDbBridge) TextSearchLegacyMemeToken(phrase string, limit int32) ([]*types.LegacyCollection, error) {
