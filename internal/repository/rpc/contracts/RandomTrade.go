...
func bindRandomTrade(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := RandomTradeMetaData.GetAbi()
	if err != nil {
		return nil, err
	}
...
func (_RandomTrade *RandomTradeCaller) WITHDRAWALDELAY(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _RandomTrade.contract.Call(opts, &out, "WITHDRAWAL_DELAY")
...
//
// Solidity: function WITHDRAWAL_DELAY() view returns(uint256)
func (_RandomTrade *RandomTradeSession) WITHDRAWALDELAY() (*big.Int, error) {
	return _RandomTrade.Contract.WITHDRAWALDELAY(&_RandomTrade.CallOpts)
}

// WITHDRAWALDELAY is a free data retrieval call binding the contract method 0x0ebb172a.
//
// Solidity: function WITHDRAWAL_DELAY() view returns(uint256)
func (_RandomTrade *RandomTradeCallerSession) WITHDRAWALDELAY() (*big.Int, error) {
	return _RandomTrade.Contract.WITHDRAWALDELAY(&_RandomTrade.CallOpts)
}
