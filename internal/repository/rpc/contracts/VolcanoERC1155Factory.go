...
// CreateNFTContract is a paid mutator transaction binding the contract method 0xba38e01f.
//
// Solidity: function createNFTContract(string _name, string _symbol, bool _private, uint256 _mintFee, uint96 _creatorFeePerc, address _feeRecipient, (string,bool,bool,string,uint256,uint256,uint256,uint256,uint256,string) _options) payable returns(address)
