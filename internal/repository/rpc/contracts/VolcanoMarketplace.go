...
func (_VolcanoMarketplace *VolcanoMarketplaceCaller) FeeReceipient(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _VolcanoMarketplace.contract.Call(opts, &out, "feeReceipient")
...
//
// Solidity: function feeReceipient() view returns(address)
func (_VolcanoMarketplace *VolcanoMarketplaceSession) FeeReceipient() (common.Address, error) {
	return _VolcanoMarketplace.Contract.FeeReceipient(&_VolcanoMarketplace.CallOpts)
}

// FeeReceipient is a free data retrieval call binding the contract method 0x3740ebb3.
//
// Solidity: function feeReceipient() view returns(address)
func (_VolcanoMarketplace *VolcanoMarketplaceCallerSession) FeeReceipient() (common.Address, error) {
	return _VolcanoMarketplace.Contract.FeeReceipient(&_VolcanoMarketplace.CallOpts)
}
